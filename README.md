...
- [Programmatic interface](docs/programmatic-interface.md)
  ...
  - [Low level bindings](docs/programmatic-interface.md#low-level-bindings)
    - [Get API version](docs/programmatic-interface.md#how-to-get-the-current-API-version)
    - [Start an analysis](docs/programmatic-interface.md#how-to-start-a-new-analysis)
    - [Get analysis results](docs/programmatic-interface.md#how-to-get-results-from-an-analysis)
    - [Cancel an analysis](docs/programmatic-interface.md#how-to-cancel-a-running-analysis)
    - [Get analysis status](docs/programmatic-interface.md#how-to-get-the-status-of-an-analysis)
